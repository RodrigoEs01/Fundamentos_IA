...
class MultiHeadAttention(nn.Module):
    ...
    def combine_heads(self, x):
        batch_size_, _, seq_length_, d_model = x.size()
        return x.transpose(1 , 2).contiguous().view(batch_size_, seq_length_, self.d_model)
...
class PositionWiseFeedForward(nn.Module):
    #   Construidos con elementos necesarios
    #===========================
...
class Transformer(nn.Module):
    # Constructor y elementos necesarios
    #================================
    def __init__(self, src_vocab_size, tgt_vocab_size, d_model, num_heads, num_layers, dropout):
    ...
    def generate_mask(self, src, tgt):
        ...
        return src_mask & nopeak_mask & tgt_mask
