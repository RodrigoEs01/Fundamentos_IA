...
batch_size = 4        #   Tamaño de conjuntos de datos
...
for epoch in range(num_epochs):
    for i, (images, labels) in enumerate (train_loader):
        #   Formato original: [4, 3, 32, 32] = 4, 3, 102
        ...
        optimizer.step()
        if (i+1) % 2000 == 0:
            print (f'Epoch [{epoch+1}/{num_epochs}], Step [{1+1}/{n_total_steps}], Loss: {loss.item():.4f}') 
