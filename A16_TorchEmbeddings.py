#===========================
#   Embedings con pytorch y lightning
#===========================
...
data = {
        ...
        "input": ["input1", "input2", "input3", "input3", "input4"]}
...
plt.text(df.wl[1], df.w2[1], df.token [1],
         horizontalalignment='left',
         size='medium',
         color='black',
         weight='semibold')
...
sns.scatterplot(data=df, x="wl", y="w2")
...
#===========================
#   Se puden poner los resultados en un objeto
