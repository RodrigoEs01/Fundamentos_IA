...
from viborita.modelo import LinearQNet, QTrainer
...
class Agente:
    ...
    def obtener_estado(self, juego):
        ...
        state = [
            ...
            (dir_r and juego.is_collision(point_l)) or
            ...
            (dir_u and juego.is_collision(point_d)) or
            (dir_u and juego.is_collision(point_d)),

            # Peligro a la izquierda 
            #=========================
            (dir_d and juego.is_collision(point_r)) or 
            (dir_d and juego.is_collision(point_l)) or 
            (dir_d and juego.is_collision(point_u)) or 
    ...
    def entrenar_memoria_larga(self):
        ...
        self.trainer.train.step(np.array(states, dtype = np.float32), actions, rewards, np.array(next_states, dtype = np.float32), dones)
    ...
    def obtener_accion(self, state):
        ...
        # JUEGOS AL AZAR juegos con posibilidad de hacer un movimiento al azar
        #=========================
        ...
        # Decisión es un vector en R3 con 0 o 1
        #=========================
        return final_move
